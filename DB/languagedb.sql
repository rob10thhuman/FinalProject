...
INSERT INTO `language` (`id`, `name`, `logo`, `creator`, `year_created`, `info`) VALUES (8, 'C#', NULL, 'Microsoft', 2000, 'C# is a general-purpose programming language closely related to Java. Compared to Java, C# features a more unified type system and better integration with databases.');
INSERT INTO `language` (`id`, `name`, `logo`, `creator`, `year_created`, `info`) VALUES (9, 'Ruby', NULL, 'Yukihiro Matsumoto', 1995, 'Ruby is a general-purpose programming language known for its unique and elegant syntax. It is also known for Ruby on Rails, a popular web framework.');
INSERT INTO `language` (`id`, `name`, `logo`, `creator`, `year_created`, `info`) VALUES (10, 'Scala', NULL, 'Martin Odersky', 2004, 'Scala is a programming language running on the Java Virtual Machine that aims to extend Java with additional features. Unlike Java, Scala has substantial support for functional programming.');
INSERT INTO `language` (`id`, `name`, `logo`, `creator`, `year_created`, `info`) VALUES (11, 'Perl', NULL, 'Larry Wall', 1987, 'Perl is a programming language based on Unix scripts optimized for text processing. Perl makes heavy use of punctuation and abbreviations to be more terse.');
INSERT INTO `language` (`id`, `name`, `logo`, `creator`, `year_created`, `info`) VALUES (12, 'Haskell', NULL, 'Simon Peyton Jones', 1990, 'Haskell is a lazily-evaluated and purely functional programming language with a rich type system. Haskell draws from concepts in advanced mathematics to approach problems from a different direction as other programming languages.');
INSERT INTO `language` (`id`, `name`, `logo`, `creator`, `year_created`, `info`) VALUES (13, 'Lua', NULL, 'Roberto Ierusalimschy', 1993, 'Lua is a programming language designed to be minimalistic and extensible. Because of Lua\'s minimalism, it has found heavy use in embedded systems and game development.');
INSERT INTO `language` (`id`, `name`, `logo`, `creator`, `year_created`, `info`) VALUES (14, 'Kotlin', NULL, 'JetBrains', 2011, 'Kotlin is a Java Virtual Machine-based programming language. Although Kotlin extends Java with a richer type system and support for functional programming, it remains fully interoperable with Java code.');
INSERT INTO `language` (`id`, `name`, `logo`, `creator`, `year_created`, `info`) VALUES (15, 'Rust', NULL, 'Graydon Hoare', 2010, 'Rust is a programming language that aims to bring stronger typing and greater safety to systems programming while maintaining performance. Rust\'s unique memory management system helps avoid the memory bugs that are common in traditional systems languages.');
