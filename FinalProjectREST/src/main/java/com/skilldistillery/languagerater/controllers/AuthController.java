...
public class AuthController {
	...
	@GetMapping("/verifyPassword/{password}/users/{id}")
	public boolean verifyPassword(@PathVariable("password") String password, @PathVariable("id") int id) {
		return authService.verifyPassword(id, password);
	}
